...
class SparseCheckoutTests(unittest.TestCase):
    ...
    def test_sparse_checkout_filters_worktree(self):
        ...
        with TempGitTree() as tempdir:
            ...
            self.assertTrue(os.path.exists(os.path.join(tempdir, "src/main/app.py")))
            self.assertTrue(os.path.exists(os.path.join(tempdir, "docs/guide.md")))
            self.assertFalse(os.path.exists(os.path.join(tempdir, "src/tests/test.py")))
