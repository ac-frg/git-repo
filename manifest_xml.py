...
"""
    ...
    def _ParseProject(self, node, parent=None, **extra_proj_attrs):
        ...
        if project.sparse_checkout and not project.sparse_paths:
            print(
                ...
                "but no sparse-path elements are defined; disabling sparse-checkout",
                file=sys.stderr,
            )
    ...
    def _ParseSparsePath(self, project: Project, node: xml.dom.minidom.Element):
        ...
        Validates that the path is appropriate for git sparse-checkout cone mode,
        which only accepts directory paths (not files or wildcards).
        ...
        Raises:
            ManifestParseError: If the path looks like a file or contains wildcards.
        """
