  ...
  subcmds)
    ...
    smartsync | sync)
      _arguments \
        ...
        '--no-sync-submodules[Do not sync submodules]' \
        '--fetch-submodules[Deprecated alias for --sync-submodules]' \
        '--no-fetch-submodules[Deprecated alias for --no-sync-submodules]' \
        '--use-superproject[Use superproject]' \
        '--no-use-superproject[Do not use superproject]' \
        '--tags[Sync tags]' \
        '--no-tags[Do not sync tags]' \
